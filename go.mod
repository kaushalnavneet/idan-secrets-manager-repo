...
require (
	...
	github.ibm.com/security-services/secrets-manager-common-utils v0.0.10551
	github.ibm.com/security-services/secrets-manager-iam v0.0.10191
	github.ibm.com/security-services/secrets-manager-vault-plugins-common v0.0.10561
