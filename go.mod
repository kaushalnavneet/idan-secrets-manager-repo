...
require (
	...
	github.ibm.com/security-services/secrets-manager-common-utils v0.0.11117
	github.ibm.com/security-services/secrets-manager-iam v0.0.11129
	github.ibm.com/security-services/secrets-manager-vault-plugins-common v0.0.11131
