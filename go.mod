...
require (
	...
	github.ibm.com/security-services/secrets-manager-common-utils v0.0.9907
	github.ibm.com/security-services/secrets-manager-iam v0.0.8072
	github.ibm.com/security-services/secrets-manager-vault-plugins-common v0.0.9916
